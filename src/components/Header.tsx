    ...
    <header className="relative min-h-screen bg-gradient-to-br from-stone-50 via-amber-50 to-stone-100 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 py-16 flex flex-col justify-center min-h-screen">
        <div className="text-center max-w-4xl mx-auto">
          ...
          {/* Tagline */}
          <p className="font-poppins text-xl md:text-2xl text-stone-600 mb-8 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="flex items-center justify-center text-stone-700 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
            ...
            <span className="font-poppins text-lg">@madammartinsbeautyclinic • 1,319 followers</span>
          </div>

          {/* CTA Button */}
          <div className="mt-12 animate-fade-in-up" style={{ animationDelay: '1s' }}>
            <button className="bg-gold-600 hover:bg-gold-700 text-white font-poppins font-semibold px-8 py-4 rounded-full text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
              Agendar Consulta
            </button>
          </div>
        </div>
